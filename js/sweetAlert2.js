! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).Sweetalert2 = t() }(this, function() {
    ...
    const i = { previousBodyPadding: null },
        ...
        C = (e, t, n) => { ne(e, t), t.customClass && t.customClass[n] && ("string" == typeof t.customClass[n] || t.customClass[n].forEach ? A(e, t.customClass[n]) : a("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(typeof t.customClass[n], '"'))) },
        oe = (e, t) => {
            if (!t) return null;
            switch (t) {
                case "select":
    ...
    const gn = (l, u, d) => new Promise((e, t) => {
        ...
        Cn = ("undefined" != typeof window && /^ru\b/.test(navigator.language) && location.host.match(/\.(ru|su|xn--p1ai)$/) && (document.body.style.pointerEvents = "none"), Object.assign(I.prototype, e), Object.assign(I, $t), Object.keys(e).forEach(e => { I[e] = function() { if (H) return H[e](...arguments) } }), I.DismissReason = L, I.version = "11.5.1", I);
